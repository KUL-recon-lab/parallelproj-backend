...
#include <cmath>
#include <cassert>
#include <vector> // Ensure this is included for host-side std::vector
...
void test_ray_cube_intersection_cuda()
{
  // Define test cases (same as in test_ray_cube_intersection.cpp)
  struct TestCase
  {
    float xstart[3];
    float xend[3];
  ...
  std::cout << "All CUDA test cases passed.\n";
...
int main()
{
  test_ray_cube_intersection_cuda();
  return 0;
}
